...
const AdminPage = () => {
  ...
  const getActiveComponent = () => {
    switch (activeContent) {
      ...
      case "Ingredient":
        return React.lazy(() =>
          import("../customOption/page/IngredientsPageComponent")
        );
      case "Franchise":
        return React.lazy(() =>
          import("../franchise/page/FranchisePageComponent")
        );
      default:
        return React.lazy(() => import("../report/page/ReportPageComponent"));
    }
  ...
  return (
    <div className="main">
      <div className="inner-main">
        <div className="username">관리자 페이지</div>
        <hr />
        <br />
        ...
        <div className="check-admin">
          <div
            className={`admin-check ${
              activeContent === "Report" ? "admin-clicked" : ""
            }`}
            onClick={() => handleDivClick("Report")}
          >
            신고접수내역
          </div>
          ...
          <div
            className={`admin-check ${
              activeContent === "Franchise" ? "admin-clicked" : ""
            }`}
          ...
          <div
            className={`admin-check ${
              activeContent === "Ingredient" ? "admin-clicked" : ""
            }`}
            onClick={() => handleDivClick("Ingredient")}
          >
            레시피 옵션 관리
          </div>
        </div>
